    ...
    <div class="flex">
        ...
        <div class="profile-detail">
            ...
            <div class="flex-btn">
               <div class="flex-btn">
    <div class="flex-btn">
    <a href="profile.php" class="btn">profile</a> <!-- প্রোফাইল পেজের লিঙ্ক -->
    <a href="admin_logout.php" onclick="return 
    confirm('logout from this website');" class="btn">logout</a>
     </div>
                <!-- <a href="../components/admin_logout.php"  onclick="return 
                confirm('logout from this website');"class="btn">logout</a> -->
