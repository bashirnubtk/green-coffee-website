...
/* delete product */
 ...
 if (isset($_POST[ 'delete'])) {
  ...
  $delete_product = $conn->products("DELETE FROM `product` WHERE id = ?");
  ...
  <div class="main">
    ...
    <section class="read-post">
      <h1 class="heading">read Product</h1>
        ...
        <div class="status" style="color: <?php echo ($fetch_product['status'] == 'active') ?
         'green' : 'red'; ?>">
        ...
        <div class = "flex-btn">
          ...
          <button type = "submit" name="delet" class = "btn" oclick = "return confirm(
               ...
               echo '
                     <div class="empty">
                        <p>no product added yet! <br> <a href="add_products .php"
                            style="margin-top:1.5rem;" class="btn">add 
                            product</a></p>
                        </div>
                    ';
             } 
